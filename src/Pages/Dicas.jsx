        ...
        <div>
            ...
            <div>
                <div className='div_dicas'>
                    ...
                    <p className='p_dicas1'>Reduzir o consumo de energia elétrica não contribui apenas para a preservação do meio ambiente, mas também para a redução de gastos e o controle das despesas em casa. É importante compreender que é papel de todos ajudar no combate ao desperdício de energia elétrica.  Quando mudamos algumas atitudes cotidianas em relação ao uso consciente, o consumo de energia reduz consideravelmente e ajudamos na preservação do meio ambiente, aumentando o tempo de vida dos recursos não-renováveis. Uma dica no geral é que quando for comprar qualquer tipo de eletrodomésticos, escolha sempre os que possuem o Selo Procel, ele indica aos consumidores que estes aparelhos consomem menos energia. A seguir veja algumas dicas de como economizar energia elétrica de forma sustentável, algumas atitudes já são bem conhecidas, mas é sempre bom reforçar.</p>
